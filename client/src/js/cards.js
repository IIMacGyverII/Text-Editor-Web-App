...
const form = document.getElementById('textEditor-form');

// Adds deleteCard() to the global scope so each card has access to it.
window.deleteCard = (e) => {
// Grabs the id from the button element attached to the textEditor card.
...
// Grab card data from IndexedDB
  ...
  // Loop through the data and create the textEditor card
